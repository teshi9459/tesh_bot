...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName("setup").setDescription("erstellt das Level System")
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("ping")
        ...
        .addBooleanOption((option) =>
          option.setName("setting").setDescription("schalte an oder aus")
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("clear")
        .setDescription(
          "löscht einen besonderen Leveltext oder eine Levelrolle"
        )
        .addIntegerOption((option) =>
          option
            .setName("level")
